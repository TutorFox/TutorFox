      ...
      <div className="panel panel-default">
        <div className="panel-heading">
          ...
          <div className="col-md-3">
            ...
            <span className="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>{this.props.likes} <span className="glyphicon glyphicon-thumbs-down" aria-hidden="true">{this.props.dislikes}</span>
          </div>
          <div className="col-md-3">
            <h5>
              <ul>
